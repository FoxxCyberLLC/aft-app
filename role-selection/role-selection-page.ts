...
import { getRoleDescription, getRoleDisplayName, type UserRoleType } from '../lib/database-bun';
...
function render(userEmail: string, userName: string, availableRoles: UserRole[]): string {
  const roleCards = availableRoles
    .map((userRole) => {
